...
/**
 * PhilSubMenu - Composant de navigation spécialisé pour le robot Phil
 * Robot Penseur avec accent violet/cyan
 */
export const PhilSubMenu: React.FC<PhilSubMenuProps> = ({
  nestedItems,
  currentPath,
  onNavigate,
  onClose,
  ...
  return (
    <div
      ...
      style={{
        ...
        borderColor: '#06b6d4',
        boxShadow: '0 0 20px rgba(6, 182, 212, 0.3), 0 4px 6px -1px rgba(0, 0, 0, 0.1)',
      }}
    >
      {/* Header du submenu */}
      ...
      <div className="px-4 py-2 border-t border-gray-600 bg-gray-900/50">
        <div className="text-xs text-gray-500 flex items-center justify-between">
          <span>PHIL sur la carte du workflow</span>
